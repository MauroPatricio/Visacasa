...
export default function Footer() {
  ...
  const handleTiktokClick = (e) => {
    e.preventDefault(); // Prevent the default navigation behavior
    const tiktokUrl = "https://www.tiktok.com/@visacasaofficial";
  ...
  const handleInstagramClick = (e) => {
    e.preventDefault(); // Prevent the default navigation behavior
    const instagramUrl = "https://www.instagram.com/visacasa/";
  ...
  return (
    <>
      ...
      >
        <section
          className="d-flex justify-content-between p-4 social-bar"
          style={{ background: 'var(--primary-gradient, #E85A4F)' }}
        >
          <div className="me-5 d-none d-md-block">
            <span className="fw-semibold">{t('stayconnected')}</span>
          </div>

          <div>
            <a href="javascript:void(0)" onClick={handleFacebookClick} className="text-white me-4">
              <i className="fab fa-facebook-f"></i>
              <FaFacebookF></FaFacebookF>
            </a>
            <a href="javascript:void(0)" onClick={handleYoutubeClick} className="text-white me-4">
              <FaYoutube></FaYoutube>
            </a>
            <a href="javascript:void(0)" onClick={handleTiktokClick} className="text-white me-4">
              <FaTiktok></FaTiktok>
            </a>
            <a href="javascript:void(0)" onClick={handleInstagramClick} className="text-white me-4">
          ...
          <div className="container text-center text-md-start mt-5">
            <div className="row mt-3">
              <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                <img style={{ width: '12rem', height: '12rem', textAlign: 'center', borderRadius: '50%' }}
                  src="images/visacasa.jpg"
                  alt="Visacasa" ></img>                </div>
        ...
        <div
          ...
          style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)', fontSize: '0.9rem' }}
        >
          © {new Date().getFullYear()} {t('reservedrights')} -
          <span className="ms-2 fw-semibold" style={{ color: 'var(--secondary-color)' }}>Visacasa</span>
        </div>
      </footer>
