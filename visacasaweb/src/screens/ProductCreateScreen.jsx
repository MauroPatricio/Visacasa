      ...
      <Container>
        <div className="product-create-card">
          ...
          <div className="product-create-header">
            <h1 className="product-create-title">{t('createproduct')}</h1>
            <p className="product-create-subtitle">Preencha os detalhes do produto para adicionar ao catálogo</p>
          </div>
          ...
          {loading ? (
            ...
            <>
              ...
              <Form onSubmit={submitHandler}>
                ...
                <Form.Group className="premium-form-group" controlId="description">
                  <Form.Label className="premium-form-label">Detalhes do produto</Form.Label>
                  <Form.Control
                ...
                <Form.Group className="premium-form-group">
                  <Form.Label className="premium-form-label">Categoria</Form.Label>
                  <Form.Select
                ...
                <Form.Group className="premium-form-group">
                  <Form.Label className="premium-form-label">Localização do produto</Form.Label>
                  <Form.Select
                    className="premium-form-select"
                    required
                    aria-label="location"
                ...
                <Form.Group className="premium-form-group" controlId="countInStock">
                  <Form.Label className="premium-form-label">Quantidade disponível</Form.Label>
                  <Form.Control
                ...
                <Form.Group className="premium-form-group" controlId="price">
                  <Form.Label className="premium-form-label">{t('price')} [MT]</Form.Label>
                  <Form.Control
                    className="premium-form-control"
                    type="number"
                    value={price}
